...
local window = library:CreateWindow("Streamer Gui") -- Creates the window

local buttons = window:CreateFolder("Buttons") -- Creates the folder(U will put here your buttons,etc)

buttons:Label("Made by liteeagle.me",{
    TextSize = 18; -- Self Explaining
    TextColor = Color3.fromRGB(255,255,255); -- Self Explaining
    BgColor = Color3.fromRGB(69,69,69); -- Self Explaining
    
})
buttons:Button("Streamer Mode",function()
    local Config =
    {
        ProtectedName = "hi!", --What the protected name should be called.
        OtherPlayers = true, --If other players should also have protected names.
        OtherPlayersTemplate = "someone", --Template for other players protected name (ex: "NamedProtect" will turn into "NameProtect1" for first player and so on)
